      ...
      >
        <div className="container">
          ...
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item">
              <ALink href="/shop/sidebar/3cols">Product Category</ALink>
            </li>
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="banner banner-cat banner-badge">
                  ...
                  <ALink
                    ...
                    href="/shop/sidebar/3cols?category=dresses"
                  >
                ...
                <div className="banner banner-cat banner-badge">
                  ...
                  <ALink
                    className="banner-link"
                    href="/shop/sidebar/3cols?category=jackets"
                  >
              ...
              <div className="col-md-6">
                <div className="row">
                  <div className="col-sm-6">
                    <div className="banner banner-cat banner-badge">
                      ...
                      <ALink
                        className="banner-link"
                        href="/shop/sidebar/3cols?category=t-shirts"
                      >
                  ...
                  <div className="col-sm-6">
                    <div className="banner banner-cat banner-badge">
                      ...
                      <ALink
                        className="banner-link"
                        href="/shop/sidebar/3cols?category=jeans"
                      >
                ...
                <div className="banner banner-cat banner-badge">
                  ...
                  <ALink
                    className="banner-link"
                    href="/shop/sidebar/3cols?category=bags"
                  >
              ...
              <div className="col-sm-6 col-md-3">
                <div className="banner banner-cat banner-badge">
                  ...
                  <ALink
                    className="banner-link"
                    href="/shop/sidebar/3cols?category=sportswear"
                  >
              ...
              <div className="col-sm-6 col-md-3 order-md-last">
                <div className="banner banner-cat banner-badge">
                  ...
                  <ALink
                    className="banner-link"
                    href="/shop/sidebar/3cols?category=jumpers"
                  >
              ...
              <div className="col-md-6">
                <div className="banner banner-cat banner-badge">
                  ...
                  <ALink
                    className="banner-link"
                    href="/shop/sidebar/3cols?category=shoes"
                  >
