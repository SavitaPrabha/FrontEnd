...
function ProductComboSearch(props) {
     ...
     return (
          ...
          ""
                    ...
                    <div className="product-action">
                         <ALink className="btn-product" href={`/product/defaultcombo/${product._id}`} >
                              <span>View</span>
                         </ALink>
                    </div>
               </figure>
            ...
            <React.Fragment key={item.slug + "-" + index}>
              ...
              {index < product.category.length - 1 ? ", " : ""}
                    ...
                    <h3 className="product-title">
                         <ALink href={`/product/defaultcombo/${product._id}`}>{product.name}</ALink>
                    </h3>
