...
function ProductFour(props) {
  ...
  function mouseOverHandler() {
    ...
    let animDistance =
      ref.current.querySelector(".product-footer").offsetHeight - animDiff;
    ref.current
      .querySelector(".product-footer")
      .setAttribute("style", "visibility: visible; transform: translateY(0);");
    ref.current
      .querySelector(".product-body")
      .setAttribute("style", "transform: translateY(" + -animDistance + "px)");
  }
