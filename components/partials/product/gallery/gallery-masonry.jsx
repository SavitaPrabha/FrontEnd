  ...
  return (
    <>
        ...
        <div className="row m-0">
          <figure className="product-main-image" index="0">
            ...
            <Magnifier
              ...
              style={{
                paddingTop: `${
                  (product.pictures[0].height / product.pictures[0].width) * 100
                }%`,
              }}
            />
      ...
      {isOpen ? (
        <LightBox
          mainSrc={
            process.env.NEXT_PUBLIC_ASSET_URI + product.pictures[photoIndex].url
          }
          nextSrc={
            process.env.NEXT_PUBLIC_ASSET_URI +
