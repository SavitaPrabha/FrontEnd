...
import ProductElevenCombo from "~/components/features/products/product-eleven-combo";
import ProductComboSearch from "~/pages/ProductComboSearch";

function ShopListOne(props) {
  const { loading, products = [],combos=[], perPage } = props;
  console.log(combos,"hjgjy")
  console.log(products,"huyigyugyg")
                                   ...
                                   {loading
                                        ...
                                        : combos.map((product, index) => (
                                             ...
                                             <div className={gridClass} key={index}>
                                                  ...
                                                  <ProductComboSearch product={product} />
                                             </div>
                                        ))}
                              </div>
                         )}
