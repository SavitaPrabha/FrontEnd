...
function ShopSidebarThree(props) {
  ...
  function containsPriceInUrl(price) {
    let flag = false;
    if (query.minPrice && query.minPrice == price.min) flag = true;
    else return false;

    if (price.max) {
      if (query.maxPrice && query.maxPrice == price.max) flag = true;
      else return false;
    }
    return true;
  }
                  ...
                  <div className="filter-item" key={index}>
                    <div className="custom-control custom-checkbox">
                      <input
                        ...
                        checked={
                          containsAttrInUrl("brand", item.slug) ? true : false
                        }
                      />
                      <label
                  ...
                  <div className="filter-item" key={index}>
                    <div className="custom-control custom-checkbox">
                      <input
                        ...
                        id={`rating-${index + 1}`}
                        onChange={(e) =>
                          onAttrClick(e, "rating", item.toString())
                        }
                        checked={
                          containsAttrInUrl("rating", item.toString())
                            ? true
                            : false
                        }
                      />
